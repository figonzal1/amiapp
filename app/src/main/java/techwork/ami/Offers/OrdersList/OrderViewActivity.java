    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle.getString("CallFrom").equals("CreateOrderActivity")){
            ...
            if (Integer.valueOf(bundle.getString(Config.TAG_GET_ORDER_EXPIRATIONDATE))==0){
                ...
                tvExpiry.setText(getApplicationContext().getResources().getString(R.string.OrderViewExpiryCreateOrder)+bundle.getString(Config.TAG_GET_ORDER_EXPIRATIONDATE)+" día");
            }
            else if (Integer.valueOf(bundle.getString(Config.TAG_GET_ORDER_EXPIRATIONDATE))>1){
                tvExpiry.setText(getApplicationContext().getResources().getString(R.string.OrderViewExpiryCreateOrder)+bundle.getString(Config.TAG_GET_ORDER_EXPIRATIONDATE)+" días");
            }
